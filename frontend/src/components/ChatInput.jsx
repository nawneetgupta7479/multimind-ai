      ...
      return (
        ...
        <button
          ...
          className={`
            ...
            ${
              isActive
                ? "bg-gradient-to-r from-blue-500 to-blue-600 text-white border-transparent shadow-[0_1px_8px_rgba(59,130,246,.35)]"
...
<Mic size={14}/>
          ...
          <button
            ...
            className={`flex items-center justify-center w-8 h-8 rounded-lg border-none cursor-pointer transition-all duration-150
              ${isLoading
                ...
                : value.trim()
                ? "bg-gradient-to-br from-blue-500 to-blue-700 hover:opacity-90 text-white"
      ...
      <p className="text-center text-[10.5px] text-slate-700 mt-2.5">
        MultiMind AI can make mistakes. Verify important info.
      </p>
    </div>
  );
}